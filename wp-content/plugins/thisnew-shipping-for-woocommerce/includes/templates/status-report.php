<div class="support-report-wrap">
	<p>
        <?php esc_html_e('Copy the box content below and add it to your support message', 'thisnew'); ?>
        <br/>
	...
	<button class="button button-primary button-large support-report-btn"><?php esc_html_e('Copy', 'thisnew'); ?></button>
