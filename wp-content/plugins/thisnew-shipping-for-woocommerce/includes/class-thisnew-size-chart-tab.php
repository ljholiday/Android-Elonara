...
class ThisNew_Size_Chart_Tab {
	...
	/**
	 * thisnew_Size_Chart_Tab constructor.
	 */
	...
	public function init_metabox() {
		add_meta_box( 'pf_size_chart', __( 'Size chart', 'thisnew' ), array( $this, 'size_chart_metabox' ), 'product', 'normal' );
	}
	...
	public function size_chart_tab_content() {
		echo '<h2>' . esc_html__( 'Size Chart', 'thisnew' ) . '</h2>';
